...
export const products: Product[] = [
  // ─── SKIN ───
  {
    ...
    price: 16, mrp: 20, rating: 4.3, ratingCount: 12450, reviewCount: 3210, tier: 'budget', skinTypes: ['oily', 'combination'], concerns: ['hydration'],
  ...
  },
  {
    ...
    price: 95, mrp: 120, rating: 4.6, ratingCount: 890, reviewCount: 245, tier: 'luxury', skinTypes: ['dry', 'sensitive'], concerns: ['hydration', 'barrier repair'],
  ...
  },
  {
    ...
    price: 166, mrp: 185, rating: 4.7, ratingCount: 2340, reviewCount: 678, tier: 'luxury', skinTypes: ['all'], concerns: ['brightening', 'anti-aging'],
  ...
  },
  {
    ...
    price: 6, mrp: 8, rating: 4.4, ratingCount: 45200, reviewCount: 11340, tier: 'budget', skinTypes: ['oily', 'combination'], concerns: ['pores', 'oil control'],
  ...
  },
  {
    ...
    price: 36, mrp: 42, rating: 4.2, ratingCount: 5670, reviewCount: 1450, tier: 'mid', skinTypes: ['all'], concerns: ['sun protection'],
  ...
  },
  {
    ...
    price: 38, mrp: 48, rating: 4.5, ratingCount: 3890, reviewCount: 920, tier: 'mid', skinTypes: ['normal', 'combination'], concerns: ['anti-aging', 'texture'],
  ...
  },
  {
    ...
    price: 32, mrp: 38, rating: 4.6, ratingCount: 8920, reviewCount: 2340, tier: 'mid', skinTypes: ['oily', 'combination'], concerns: ['acne', 'pores'],
  ...
  },
  {
    ...
    price: 52, mrp: 62, rating: 4.4, ratingCount: 6780, reviewCount: 1890, tier: 'mid', skinTypes: ['dry', 'sensitive'], concerns: ['barrier repair', 'hydration'],
  ...
  },
  {
    ...
    price: 8, mrp: 10, rating: 4.1, ratingCount: 15670, reviewCount: 4230, tier: 'budget', skinTypes: ['all'], concerns: ['acne', 'redness'],
  ...
  },
  {
    ...
    price: 120, mrp: 150, rating: 3.9, ratingCount: 430, reviewCount: 120, tier: 'luxury', skinTypes: ['normal'], concerns: ['hydration'],
  ...
  // ─── HAIR ───
  {
    ...
    price: 48, mrp: 55, rating: 4.3, ratingCount: 3450, reviewCount: 890, tier: 'mid', skinTypes: ['all'], concerns: ['hair hydration'],
  ...
  },
  {
    ...
    price: 34, mrp: 40, rating: 4.2, ratingCount: 2890, reviewCount: 670, tier: 'mid', skinTypes: ['all'], concerns: ['hair hydration'],
  ...
  },
  {
    ...
    price: 22, mrp: 28, rating: 4.1, ratingCount: 18900, reviewCount: 5430, tier: 'mid', skinTypes: ['all'], concerns: ['hair fall'],
  ...
  },
  {
    ...
    price: 8, mrp: 12, rating: 4.0, ratingCount: 23400, reviewCount: 6780, tier: 'budget', skinTypes: ['all'], concerns: ['frizz control'],
  ...
  },
  {
    ...
    price: 12, mrp: 18, rating: 4.2, ratingCount: 34500, reviewCount: 8900, tier: 'budget', skinTypes: ['all'], concerns: ['hair growth'],
  ...
  // ─── MAKEUP ───
  {
    ...
    price: 40, mrp: 48, rating: 4.5, ratingCount: 9870, reviewCount: 2340, tier: 'mid', skinTypes: ['all'], concerns: ['coverage'],
  ...
  },
  {
    ...
    price: 34, mrp: 40, rating: 4.6, ratingCount: 5670, reviewCount: 1560, tier: 'mid', skinTypes: ['all'], concerns: ['makeup'],
  ...
  },
  {
    ...
    price: 33, mrp: 40, rating: 4.4, ratingCount: 7890, reviewCount: 2100, tier: 'mid', skinTypes: ['all'], concerns: ['makeup longevity'],
  ...
  },
  {
    ...
    price: 4, mrp: 5, rating: 4.3, ratingCount: 67800, reviewCount: 18900, tier: 'budget', skinTypes: ['all'], concerns: ['eye makeup'],
  ...
  },
  {
    ...
    price: 7, mrp: 10, rating: 4.2, ratingCount: 45600, reviewCount: 12300, tier: 'budget', skinTypes: ['oily', 'combination'], concerns: ['oil control'],
  ...
  },
  {
    ...
    price: 10, mrp: 13, rating: 4.1, ratingCount: 23400, reviewCount: 5670, tier: 'budget', skinTypes: ['all'], concerns: ['lash volume'],
  ...
  // ─── BATH & BODY ───
  {
    ...
    price: 14, mrp: 18, rating: 4.5, ratingCount: 12300, reviewCount: 3450, tier: 'mid', skinTypes: ['all'], concerns: ['body cleansing'],
  ...
  },
  {
    ...
    price: 6, mrp: 8, rating: 4.3, ratingCount: 56700, reviewCount: 15600, tier: 'budget', skinTypes: ['dry'], concerns: ['body moisturizing'],
  ...
  },
  {
    ...
    price: 10, mrp: 14, rating: 4.4, ratingCount: 34500, reviewCount: 9800, tier: 'budget', skinTypes: ['all'], concerns: ['exfoliation', 'tan removal'],
  ...
  // ─── NATURAL ───
  {
    ...
    price: 35, mrp: 45, rating: 4.5, ratingCount: 8900, reviewCount: 2340, tier: 'mid', skinTypes: ['all'], concerns: ['brightening', 'anti-aging'],
  ...
  },
  {
    ...
    price: 5, mrp: 7, rating: 4.0, ratingCount: 23400, reviewCount: 6780, tier: 'budget', skinTypes: ['all'], concerns: ['soothing', 'hydration'],
  ...
  },
  {
    ...
    price: 18, mrp: 22, rating: 4.3, ratingCount: 11200, reviewCount: 3120, tier: 'mid', skinTypes: ['all'], concerns: ['toning', 'refreshing'],
  ...
  // ─── MOM & BABY ───
  {
    ...
    price: 8, mrp: 10, rating: 4.2, ratingCount: 15600, reviewCount: 4230, tier: 'budget', skinTypes: ['sensitive'], concerns: ['gentle cleansing'],
  ...
  },
  {
    ...
    price: 15, mrp: 20, rating: 4.1, ratingCount: 9870, reviewCount: 2560, tier: 'mid', skinTypes: ['all'], concerns: ['stretch marks'],
  ...
  },
  {
    ...
    price: 12, mrp: 15, rating: 4.3, ratingCount: 4560, reviewCount: 1230, tier: 'mid', skinTypes: ['sensitive'], concerns: ['sun protection'],
  ...
  // ─── HEALTH & WELLNESS ───
  {
    ...
    price: 30, mrp: 38, rating: 3.8, ratingCount: 6780, reviewCount: 1890, tier: 'mid', skinTypes: ['all'], concerns: ['hair growth'],
  ...
  },
  {
    ...
    price: 45, mrp: 55, rating: 4.0, ratingCount: 3450, reviewCount: 890, tier: 'mid', skinTypes: ['all'], concerns: ['skin elasticity', 'joint health'],
  ...
  },
  {
    ...
    price: 12, mrp: 16, rating: 4.1, ratingCount: 12300, reviewCount: 3450, tier: 'budget', skinTypes: ['all'], concerns: ['heart health', 'skin health'],
  ...
  // ─── MEN ───
  {
    ...
    price: 8, mrp: 12, rating: 4.0, ratingCount: 8900, reviewCount: 2340, tier: 'budget', skinTypes: ['oily'], concerns: ['deep cleansing', 'oil control'],
  ...
  },
  {
    ...
    price: 10, mrp: 14, rating: 3.9, ratingCount: 12300, reviewCount: 3450, tier: 'budget', skinTypes: ['all'], concerns: ['beard growth'],
  ...
  },
  {
    ...
    price: 12, mrp: 16, rating: 4.1, ratingCount: 5670, reviewCount: 1560, tier: 'budget', skinTypes: ['oily', 'combination'], concerns: ['acne', 'oil control'],
  ...
  // ─── FRAGRANCE ───
  {
    ...
    price: 95, mrp: 120, rating: 4.7, ratingCount: 4560, reviewCount: 1230, tier: 'luxury', skinTypes: ['all'], concerns: ['fragrance'],
  ...
  },
  {
    ...
    price: 110, mrp: 140, rating: 4.8, ratingCount: 3890, reviewCount: 980, tier: 'luxury', skinTypes: ['all'], concerns: ['fragrance'],
  ...
  },
  {
    ...
    price: 12, mrp: 15, rating: 4.2, ratingCount: 18900, reviewCount: 5670, tier: 'budget', skinTypes: ['all'], concerns: ['light fragrance'],
  ...
  // ─── APPLIANCES ───
  {
    ...
    price: 35, mrp: 45, rating: 4.3, ratingCount: 7890, reviewCount: 2100, tier: 'mid', skinTypes: ['all'], concerns: ['hair styling'],
  ...
  },
  {
    ...
    price: 55, mrp: 70, rating: 4.4, ratingCount: 5670, reviewCount: 1450, tier: 'mid', skinTypes: ['all'], concerns: ['hair straightening'],
  ...
  },
  {
    ...
    price: 80, mrp: 100, rating: 4.5, ratingCount: 2340, reviewCount: 670, tier: 'luxury', skinTypes: ['all'], concerns: ['deep cleansing'],
  ...
  // ─── LINGERIE & ACCESSORIES ───
  {
    ...
    price: 14, mrp: 18, rating: 4.1, ratingCount: 9870, reviewCount: 2560, tier: 'budget', skinTypes: ['all'], concerns: ['comfort'],
  ...
  },
  {
    ...
    price: 10, mrp: 13, rating: 4.3, ratingCount: 6780, reviewCount: 1890, tier: 'budget', skinTypes: ['all'], concerns: ['sleep quality'],
  ...
  },
  {
    ...
    price: 15, mrp: 20, rating: 4.2, ratingCount: 5670, reviewCount: 1560, tier: 'mid', skinTypes: ['all'], concerns: ['de-puffing', 'lymphatic drainage'],
